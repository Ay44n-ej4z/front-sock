...
function FirstUser() {
    ...
    return (
        <div className="container mx-auto p-4">
            <h1 className="text-2xl font-bold mb-4">User 1</h1>
                            ...
                            <div className=' mb-4'>
                                <div className="flex">
                                    ...
                                    <label class="inline-flex relative items-center mr-5 cursor-pointer">
                                        ...
                                        <div
                                            onClick={() => {
                                                socket.emit('toggleLight', { roomId: 'roomId1', roomType: 'bedroom', light: !bedroomLights.light1 , });
                                                setBedroomLights({ ...bedroomLights, light1: !bedroomLights.light1 })
                                            }}
                            ...
                            <div>
                                ...
                                <div className="flex">
                                    ...
                                    <label class="inline-flex relative items-center mr-5 cursor-pointer">
                                        ...
                                        <div
                                            onClick={() => {
                                                socket.emit('toggleLight', { roomId: 'roomId1', roomType: 'bedroom', light: !bedroomLights.light2});
                                                setBedroomLights({ ...bedroomLights, light2: !bedroomLights.light2 })}}
                                            className="w-11 h-6 bg-gray-400 rounded-full peer  peer-focus:ring-green-300  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-green-600"
                                        ></div>
                                        <span className="ml-2 text-sm font-medium text-gray-900">
                                            ON
                            ...
                            <div className=' mb-4'>
                                <div className="flex">
                                    ...
                                    <label class="inline-flex relative items-center mr-5 cursor-pointer">
                                        ...
                                        <div
                                            onClick={() =>{ 
                                                socket.emit('toggleLight', { roomId: 'roomId1', roomType: 'kitchen', light: !kitchenLights.light1});
                                                setKitchenLights({ ...kitchenLights, light1: !kitchenLights.light1 })
                                            }}
                                            className="w-11 h-6 bg-gray-400 rounded-full peer  peer-focus:ring-green-300  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-green-600"
                                        ></div>
                                        <span className="ml-2 text-sm font-medium text-gray-900">
                            ...
                            <div>
                                ...
                                <div className="flex">
                                    ...
                                    <label class="inline-flex relative items-center mr-5 cursor-pointer">
                                        ...
                                        <div
                                            onClick={() =>{
                                                socket.emit('toggleLight', { roomId: 'roomId1', roomType: 'kitchen', light: !kitchenLights.light2});
                                                setKitchenLights({ ...kitchenLights, light2: !kitchenLights.light2 })
                                            }}
                                            className="w-11 h-6 bg-gray-400 rounded-full peer  peer-focus:ring-green-300  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-green-600"
                                        ></div>
                                        <span className="ml-2 text-sm font-medium text-gray-900">
